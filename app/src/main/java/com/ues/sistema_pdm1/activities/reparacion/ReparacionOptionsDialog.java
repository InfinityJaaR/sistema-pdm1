...
public class ReparacionOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;

    public static ReparacionOptionsDialog newInstance(Reparacion reparacion) {
        ReparacionOptionsDialog dialog = new ReparacionOptionsDialog();
