...
public class PersonalInternoOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;

    public static PersonalInternoOptionsDialog newInstance(PersonalInterno p) {
        PersonalInternoOptionsDialog dialog = new PersonalInternoOptionsDialog();
        Bundle args = new Bundle();
        args.putString("NOMBRE", p.getNombrePersonal() + " " + p.getApellidoPersonal());
