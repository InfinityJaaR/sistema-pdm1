...
public class MovimientoOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;

    public static MovimientoOptionsDialog newInstance(Movimiento m) {
        MovimientoOptionsDialog dialog = new MovimientoOptionsDialog();
