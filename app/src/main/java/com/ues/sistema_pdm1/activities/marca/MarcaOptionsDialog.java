...
public class MarcaOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;

    public static MarcaOptionsDialog newInstance(Marca marca) {
        MarcaOptionsDialog dialog = new MarcaOptionsDialog();
