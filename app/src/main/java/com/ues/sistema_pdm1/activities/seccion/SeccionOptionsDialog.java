...
import com.ues.sistema_pdm1.activities.bodega.BodegaOptionsDialog;
import com.ues.sistema_pdm1.models.Seccion;

public class SeccionOptionsDialog extends DialogFragment {
    private Runnable onVer, onEditar, onEliminar;

    public static SeccionOptionsDialog newInstance(Seccion seccion) {
        SeccionOptionsDialog dialog = new SeccionOptionsDialog();
