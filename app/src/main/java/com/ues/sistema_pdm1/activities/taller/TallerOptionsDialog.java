...
public class TallerOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;
    public static TallerOptionsDialog newInstance(Taller taller) {
        TallerOptionsDialog dialog = new TallerOptionsDialog();
