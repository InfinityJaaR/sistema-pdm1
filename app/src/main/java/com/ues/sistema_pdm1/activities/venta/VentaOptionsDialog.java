...
public class VentaOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;

    public static VentaOptionsDialog newInstance(Venta venta) {
        VentaOptionsDialog dialog = new VentaOptionsDialog();
        Bundle args = new Bundle();
        args.putInt("ID", venta.getId());
