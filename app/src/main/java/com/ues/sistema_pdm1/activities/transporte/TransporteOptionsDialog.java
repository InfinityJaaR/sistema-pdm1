...
public class TransporteOptionsDialog extends DialogFragment {

    private Runnable onVer, onEditar, onEliminar;

    public static TransporteOptionsDialog newInstance(Transporte t) {
        TransporteOptionsDialog dialog = new TransporteOptionsDialog();
